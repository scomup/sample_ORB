...
public:
    ...
    int SearchForInitializationByProjection(Frame &F1, Frame &F2, std::vector<cv::Point2f> &vbPrevMatched, std::vector<int> &vnMatches12);
    ...
    int SearchNearby(KeyFrame* pKF,Frame &F);
