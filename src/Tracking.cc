...
Tracking::Tracking(System *pSys, FrameDrawer *pFrameDrawer, MapDrawer *pMapDrawer, Map *pMap,  const string &strSettingPath, const int sensor):
...
bool Tracking::TrackReferenceKeyFrame()
{
    ...
    int nmatches = matcher.SearchNearby(mpReferenceKF,mCurrentFrame,vpMapPointMatches);
...
{
    std::cout<<"TODO Relocalization"<<std::endl;
    return false;
